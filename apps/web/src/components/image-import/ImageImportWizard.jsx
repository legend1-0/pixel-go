      ...
      {!sourceImage ? (
        ...
        <>
          ...
          <div className="wizard__preview-frame">
            <canvas ref={previewCanvasRef} className="wizard__preview-canvas" />
          </div>

          <div className="wizard__section">
            <div className="wizard__slider-row">
              <label className="wizard__label" style={{ marginBottom: 0 }}>Brightness</label>
          ...
          {paletteMode === "auto" && (
            <div className="wizard__section">
              <div className="wizard__slider-row">
                <label className="wizard__label" style={{ marginBottom: 0 }}>Colors (0 = off)</label>
